	...
	public static void main(String[] args) {
		...
		/*
			3. printf()
			   ...
			   - 문자열을 +로 이어붙이는 것 보다 서식을 사용하는 경우가 편리할 때도 있다
		  	   - 줄을 자동으로 바꿔주지 않는다
		 */
		...
		/*
		  	# 서식 문자의 종류
		  	  %d 	 : 해당 자리에 전달한 정수를 10진수 정수로 출력해준다 (decimal)
		  	  %x, %X : 해당 자리에 전달한 정수를 16진수 정수로 출력해준다 (%X는 대문자, hexa decimal)
		  	  %o 	 : 해당 자리에 전달한 정수를 8진수 정수로 출력해준다 (octal)
		  	  %s	 : 문자열 (String)
		  	  %c	 : 문자 (char)
		  	  %f	 : 실수 (float)
