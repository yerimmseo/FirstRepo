...
public class D09_findEmail {
	...
	/*
		이메일을 판별할 수 있는 정규표현식을 작성하고 테스트 해보세요
	*/
	public static void main(String[] args) {
		
		// 다음 문자열에서 이메일만 골라서 ArrayList에 차곡차곡 정리한 후 한번 출력해보세요
		// 제대로 된 이메일이 몇개인지도 세보기
		...
		Pattern regex2 = Pattern.compile("[\\w]+@[\\w]+\\.(com|net|co.kr)");
		Matcher email_matcher = regex.matcher(text);
		...
		while (email_matcher.find()) {
			...
			System.out.println(email_matcher.group());
			count++;
		}
